        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900">InkMaster Studio</h1>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Badge variant="outline" className="text-blue-600 border-blue-600">
                ...
                Today: {todaysAppointments.length} appointments
              </Badge>
            </div>
          </div>
        </div>
                ...
                <Card key={client.id}>
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-sm text-gray-500">Total Sessions: {client.totalSessions}</p>
                        <p className="text-sm text-gray-500">Total Spent: ${client.totalSpent}</p>
